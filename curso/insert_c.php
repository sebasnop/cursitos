...
if($_POST["tipo"]==="SINCRONICO"){
	$query="INSERT INTO `curso`(`codigo`,`nombre`, `categoria`, `descripcion`,`cantidad_estudiantes`,`fecha_publicacion`,`tipo`, `profesor_ensenia`,`admin_supervisa`,`cupos_disponibles`,`fecha_fin`)
 	VALUES ('$_POST[codigo]','$_POST[nombre]','$_POST[categoria]','$_POST[descripcion]','$_POST[cantidad_estudiantes]','$_POST[fecha_publicacion]','$_POST[tipo]','$_POST[profesor_ensenia]','$_POST[admin_supervisa]','$_POST[cupos_disponibles]','$_POST[fecha_fin]')";
} else{
